...
def load_train_data(train_data_path):
    ...
    try:
        ...
        print("Train Data load unsuccessful")
...
def load_new_data(test_data_path):
    try:
        ...
        print("New data load unsuccessful")
...
def prepare_data(data):
    ...
    # Convert categorical columns to numeric using appropriate encoding
    # For simplicity, using one-hot encoding for categorical features
